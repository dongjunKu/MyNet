...
class HeadPac(nn.Module):
    def __init__(self, max_disparity=192, num_channels=[1, 64, 128, 256, 512, 1024]):
    ...
    def forward(self, x, multiscale=False):
        ...
        h2, k2 = self.conv2_1(h2, return_kernel=True) # 커널 shape: (N, C, kernel_h, kernel_w, out_h, out_w)
        h2 = self.relu2_1(h2)
        ...
        h3, k3 = self.conv3_1(h3, return_kernel=True)
        h3 = self.relu3_1(h3)
        ...
        h4, k4 = self.conv4_1(h4, return_kernel=True)
        h4 = self.relu4_1(h4)
        ...
        h5, k5 = self.conv5_1(h5, return_kernel=True)
        h5 = self.relu5_1(h5)
